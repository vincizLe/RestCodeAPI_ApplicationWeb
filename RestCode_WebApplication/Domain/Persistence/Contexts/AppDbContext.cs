...
namespace RestCode_WebApplication.Domain.Persistence.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Publication>().Property(p => p.DatePublished).IsRequired();
            ...
            builder.Entity<Comment>().Property(p => p.DatePublished).IsRequired();
            builder.Entity<Comment>().Property(p => p.Description).IsRequired().HasMaxLength(500);

            builder.Entity<Comment>().HasData
                (
                    new Comment { Id = 200, 
                        DatePublished = DateTime.Parse("2020/01/06"), 
                        Description = "La consultora Ana es muy confiable.", 
                        PublicationId = 100 },
                    new Comment { Id = 201, 
                        DatePublished = DateTime.Parse("2019/12/20"), 
